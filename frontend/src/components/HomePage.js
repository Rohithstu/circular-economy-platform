          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              ...
              <p className="mt-2 text-gray-600">
                From landfills through our platform
              </p>
            </div>
            <div className="p-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-600">
              Simple steps to join the circular economy
            </p>
          </div>
            ...
            {[
              {
                ...
                text: "Post your surplus materials or by-products for other businesses to use.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                text: "Discover materials you need for your operations at reduced costs or for free.",
                icon: (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-8 w-8"
              ...
              },
              {
                ...
                text: "Build relationships with other businesses and complete sustainable transactions.",
                icon: (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-8 w-8"
              ...
              <div
                ...
                className="flex flex-col justify-center items-center text-center
                           ...
                           aspect-square transition-all duration-300 hover:shadow-lg"
              >
                <div className="mx-auto flex items-center justify-center h-14 w-14 
                                rounded-md bg-green-100 text-green-600 mb-4">
                  {item.icon}
                </div>
